...
struct at_urc
{
    ...
    void (*func)(struct at_client *client, const char *data, oc_size_t size);
};
...
struct at_client
{
    ...
    oc_size_t recv_line_len;
    /* The maximum supported receive data length */
    oc_size_t recv_bufsz;
    osSemaphoreId rx_notice;
    osMutexId lock;

    at_response_t resp;
    osSemaphoreId resp_notice;
    at_resp_status_t resp_status;

    struct at_urc_table *urc_table;
    oc_size_t urc_table_size;
...
int at_obj_set_urc_table(at_client_t client, const struct at_urc * table, oc_size_t size);
