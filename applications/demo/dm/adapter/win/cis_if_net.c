...
#include "../../../../../oc/kernel/inc/cmsis_os.h"
...
cis_ret_t cisnet_connect(cisnet_t netctx)
{
   ...
   ((struct st_cis_context *)(netctx->context))->netCallback.hander = osiThreadCreate("cisnet_recv", callbackRecvThread,(void *)netctx, osPriorityNormal, 8192 * 4, 32);
