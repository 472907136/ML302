 ...
 */
int cm_fs_fopen(const char * filename,int flag);
/**
 *  \brief 关闭一个文件
 *  
 *  \param [in] fd 文件描述符
 ...
 *  \details More details
 */
int cm_fs_fread(int fd,unsigned char* buf,int len);
/**
 *  \brief 写入文件内容
 *  
 *  \param [in] fd 文件描述符
 ...
 *  \details More details
 */
int cm_fs_fwrite(int fd,unsigned char* buf,int len);
/**
 *  \brief 删除文件
 *  
 *  \param [in] filename 文件路径
 ...
 *  \details More details
 */
int cm_fs_fdelete(const char * filename);
/**
 *  \brief 同步文件
 *  
 *  \param [in] fd 文件描述符
 ...
 *  \details More details
 */
int cm_fs_fseek(int fd,int offset,int base);
/**
 *  \brief 创建文件夹
 *  
 *  \param [in] dir 文件夹路径
 ...
 *  \details More details
 */
int cm_fs_mkdir(const char * dir);
/**
 *  \brief 删除文件夹
 *  
 *  \param [in] dir 文件夹路径
 ...
 *  \details More details
 */
int cm_fs_rmdir(const char *dir);
/**
 *  \brief 打开一个文件夹
 *  
 *  \param [in] dir 文件夹的路径
 ...
 *  \details More details
 */
DIR* cm_fs_opendir(const char * dir);
/**
 *  \brief 关闭一个文件夹
 *  
 ...
 *  \details More details
 */
struct dirent * cm_fs_readdir(DIR * dir);
/**
 *  \brief 读取文件系统剩余空间
 *  
